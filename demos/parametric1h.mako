...
new Demo {camera: position: [1.5, 3, 1.5]}, () ->
    ...
    updateCaption = () =>
        str = "(x, y, z) = (-5z,\\, -2z,\\, z) = \\color{#{pointColor.str()}}{"
        str += "({#{(-5*params.z).toFixed 2}},\\," \
            +  " {#{(-2*params.z).toFixed 2}},\\," \
            +  " {#{params.z.toFixed 2}})}"
    ...
    subspace1 = @subspace
        ...
        live: false
        name: "plane1"
    subspace1.draw clipCube.clipped
    ...
    subspace3 = @subspace
        ...
        name: "line"
        live: false
    subspace3.draw clipCube.clipped
    ...
    view
        .array
            ...
            width:    1
            expr: (emit) ->
                emit -5*params.z, -2*params.z, params.z
        .point
    ...
    @caption '''<p><span id="eqn1-here"></span><br>
             ...
             '''
    katex.render "\\color{#{plane1Color.str()}}{2x + \\phantom{2}y + 12z = 0}",
                 document.getElementById 'eqn1-here'
    katex.render "\\color{#{plane2Color.str()}}{\\phantom{2}x + 2y + \\phantom{1}9z = 0}",
